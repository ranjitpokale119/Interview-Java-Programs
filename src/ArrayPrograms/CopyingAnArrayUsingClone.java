...
public class CopyingAnArrayUsingClone {
	public static void main(String[] args) {
		...
		System.out.println(" b[2] "+b[2]); // value of 3rd element in array 'b' will not
									// change

		b[4] = 100; // Changing value of 5th element in array 'b'

		System.out.println(" a[4] "+a[4]); // value of 5th element in array 'a' will not
									// change
	}
}